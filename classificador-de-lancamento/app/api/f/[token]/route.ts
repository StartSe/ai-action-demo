...
// capacidade "formulario" não está declarada em catalogo.json para classificador-de-lancamento — o
// fluxo é sempre a própria pessoa subindo os dois CSVs na tela, nunca um link público de terceiro.
