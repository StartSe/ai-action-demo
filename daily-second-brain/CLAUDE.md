...
Produto independente criado em 21/09/2026, versão 1.1.2. Referências de experiência: Build Agentflows e Vídeos de Campanha. Mantém Node 22+, Next.js 16, conta administrativa, configuração cifrada em SQLite, saída standalone, imagem GHCR e Blueprint Render da suíte.
