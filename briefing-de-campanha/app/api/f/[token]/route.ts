...
// Este app não registra nenhum tipo de formulário público — nenhum callback é chamado,
// mas a rota continua existindo porque app/f/[token]/page.tsx (compartilhado) depende dela.
