...
export function Connections({
  ...
  return (
    <Modal title="Conecte sua inteligência" onClose={onClose}>
      <p className="muted">
      ...
      <div className="provider-tabs">
        {(["chatgpt", "openrouter"] as const).map((p) => (
          ...
          >
            ...
            <small>
              {p === "chatgpt" ? "Use sua assinatura" : "Escolha entre modelos"}
            </small>
          </button>
        ))}
      </div>
      {provider === "chatgpt" ? (
        <div className="connection-card">
          ...
          <p>
            Entre com uma assinatura que inclua acesso ao Codex. O uso segue os
          ...
          {status?.chatgpt ? (
            ...
            <div className="device-login">
              ...
              <small>
                Aguardando confirmação… Se solicitado, habilite login por código
                de dispositivo nas configurações de segurança do ChatGPT.
              </small>
              <button
                className="text-button"
                onClick={() =>
      ...
      <div className="modal-footer">
        <span className="muted small">Credenciais protegidas no servidor.</span>
        <button
          className="primary"
