...
import { pesquisaEnabled } from "./pesquisa-cliente";
import { ligacaoEnabled, ttsEnabled } from "./voz";
...
export function statusExtra(): Record<string, boolean> {
  return { tts: ttsEnabled(), ligacao: ligacaoEnabled(), cultura: culturaConfigurada(), pesquisa: pesquisaEnabled() };
}
