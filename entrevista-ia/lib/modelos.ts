...
export const MODELOS_GRATUITOS: Opcao[] = [
  { valor: "openai/gpt-5.4-mini", rotulo: "OpenAI GPT-5.4 mini (pago, padrão)", grupo: "recomendado" },
  { valor: "nvidia/nemotron-3-super-120b-a12b:free", rotulo: "Nemotron 3 Super 120B (gratuito)", grupo: "gratuito" },
