...
export function AcessoMCP() {
  ...
  const configuracao = codigoNovo
    ? JSON.stringify(
        { mcpServers: { "entrevista-ia": { url: endereco, headers: { Authorization: `Bearer ${codigoNovo}` } } } },
        null,
        2
      )
    : null;
      ...
      <details className="group">
        ...
        <div className="mt-4">
          <p className="text-muted text-sm mb-4 max-w-[640px]">
            Gere um código de acesso para que um assistente de IA (Claude, ChatGPT e outros) consulte scorecards de entrevistas diretamente pela conversa, sem precisar abrir o navegador.
          </p>
