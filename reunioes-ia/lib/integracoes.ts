...
import { OPENROUTER, MCP_TAREFAS, type Integracao } from "./setup-comum";
...
export const INTEGRACOES: Integracao[] = [OPENROUTER, TRANSCRICAO_ELEVENLABS, TRANSCRICAO_OPENAI, MCP_TAREFAS];
