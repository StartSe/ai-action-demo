...
export type Pesquisa = { termos: TermoPesquisa[]; fontes: FontePesquisa[]; provedores: IdFonteBusca[]; periodoDias: number; setor: string };
export const PESQUISA_PADRAO: Pesquisa = { termos: [], fontes: [], provedores: COLETORES.map(p => p.id), periodoDias: 30, setor: "" };
