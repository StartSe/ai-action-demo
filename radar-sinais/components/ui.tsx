...
/** Cabeçalho da suíte: marca à esquerda, navegação ao centro (desktop) e chip de status + conta à direita; no celular a navegação e a conta viram um botão "Menu" com uma folha. */
