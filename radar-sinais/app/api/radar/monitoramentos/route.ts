...
import { atualizarMonitoramento, criar, listar, obter } from "@/lib/rotinas";
...
export async function GET(req: Request) {
  ...
  return Response.json({ itens: listar<Monitoramento>().filter(r => r.tipo === TIPO_MONITORAMENTO && r.parametros.radarId === radarId) });
}
