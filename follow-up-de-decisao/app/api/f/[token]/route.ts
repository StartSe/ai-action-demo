...
// cada app pode precisar importar seu próprio módulo (ex.: lib/pdi.ts em pdi-time) para garantir que o
// callback já esteja registrado quando a rota carrega. Este app ainda não tem a capacidade "formulario"
// (nenhum callback registrado) — nenhum import próprio é necessário aqui por enquanto.
