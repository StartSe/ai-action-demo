...
export function recipe(id: string): Project {
  if (id === "ugc") {
    ...
    idea.data.prompt = "Crie uma campanha UGC natural e autêntica para apresentar os produtos A e B. Use a mesma influencer nas duas peças, com linguagem próxima. O produto é o protagonista: uma peça exclusiva para A e outra exclusiva para B, sem misturar ou substituir produtos. Preserve exatamente o produto de cada referência, incluindo forma, cor, material, embalagem e identidade visual. Não invente benefícios ou resultados. As imagens devem ser fotografias sem textos adicionados: sem legendas, títulos, slogans, letras, preços, selos ou marcas d’água.";
    influencer.data.title = "Imagem da influencer";
    influencer.data.prompt = "Crie uma influencer adulta em um ambiente cotidiano, com luz natural e estética de conteúdo gravado no celular. Enquadramento médio, expressão espontânea, mãos vazias e espaço livre no centro para apresentar o produto nas próximas etapas. Não inclua produtos genéricos nem embalagens inventadas. Mantenha uma identidade visual consistente para as duas peças. Gere somente a fotografia: não adicione nenhum texto, legenda, título, slogan, letra, selo ou marca d’água na imagem.";
    ...
    for (const [index, product, video] of [[0, productA, videoA], [1, productB, videoB]] as const) {
      ...
      product.data.prompt = `Crie uma fotografia UGC da mesma influencer demonstrando exclusivamente o produto ${label} da referência selecionada nesta etapa. Essa referência é a única fonte para a identidade do produto; a imagem conectada da influencer define apenas rosto, roupa e ambiente. O produto é o protagonista: grande o suficiente para reconhecer seus detalhes, em primeiro plano, com foco nítido, boa iluminação e sem cortes. A influencer apoia a demonstração, sem encobrir o produto com mãos, rosto ou acessórios. Reproduza exatamente forma, proporções, cores, material, embalagem e os detalhes visuais existentes na referência. Não substitua por um produto semelhante, não invente características e não inclua outro produto. Gere somente a fotografia, sem acrescentar nenhum texto, legenda, título, slogan, letra, preço, selo ou marca d’água na imagem. Não escreva “produto ${label}” nem qualquer trecho deste prompt na composição.`;
      product.data.ratio = "9:16";
      product.position = { x: 820, y: index * 480 };
      video.data.title = `Vídeo UGC · Produto ${label}`;
      video.data.prompt = `Anime a imagem de entrada em uma única tomada contínua de UGC, sem cortes nem transições. Nesta peça, demonstre exclusivamente o produto ${label} exato que aparece na imagem: não use produtos alternativos citados no briefing. O produto é o protagonista e deve permanecer visível, nítido, bem iluminado e em destaque do primeiro ao último quadro. Preserve rigorosamente a mesma identidade durante todo o vídeo: forma, tamanho, proporções, cor, material, embalagem e detalhes visuais existentes na referência. Trate o produto como um objeto rígido e estável: não transforme, deforme, duplique, substitua, faça desaparecer ou troque de produto em nenhum momento. A influencer mantém rosto, roupa e ambiente; apresenta o produto com gestos pequenos e naturais, sem encobri-lo com as mãos ou tirá-lo do enquadramento. Use câmera estável de celular ou aproximação muito suave, sem giros bruscos, zooms extremos ou mudança de cena. Não acrescente outros produtos, textos, legendas, slogans, selos, marcas d’água ou promessas de resultado.`;
