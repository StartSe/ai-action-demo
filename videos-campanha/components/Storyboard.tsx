 ...
 */
export function Storyboard({ cenas, formato, imagem, titulo }: { cenas: Cena[]; formato: Formato; imagem?: string; titulo: string }) {
    ...
    <div className="flex flex-col items-center gap-2">
      ...
      >
        <div
          ...
          style={imagem ? { backgroundImage: `url("${imagem}")` } : { backgroundImage: "radial-gradient(circle at 50% 40%, #be185d 0%, #4a1942 55%, #1c1530 100%)" }}
        />
