...
## O que resolve
O CFO não sabe quanto a empresa gasta com ferramentas de IA (ChatGPT, Claude, Copilot, Midjourney, ElevenLabs, Notion AI...) nem se está dentro do orçamento. Este app lê as faturas lançadas, agrega por ferramenta e por mês, e mostra o total do período contra o planejado — com aviso de quem estourou. Nesta primeira versão, as faturas entram lançadas manualmente ou via o orçamento planejado cadastrado uma vez; ler notas de e-mail (US-020) e enviar o resumo em PDF por e-mail (US-021) chegam nas próximas etapas — os dois botões já aparecem no painel, desabilitados, para deixar claro o que vem a seguir.
