...
// cada app pode precisar importar seu próprio módulo (ex.: lib/leitura.ts) para garantir que o callback
...
// capacidade "formulario" não está declarada em catalogo.json para custos-ia.
