...
// planejado e dois meses que estouram esse orçamento (ver FERRAMENTAS_DEMO, mês -1 e mês 0 abaixo).
...
export function orcamentoDemo(): Orcamento[] {
  return [
    { item: "ChatGPT Enterprise", valorMensalBRL: 3200 },
    { item: "Claude for Work", valorMensalBRL: 2200 },
    { item: "GitHub Copilot Business", valorMensalBRL: 1200 },
    { item: "Midjourney Pro", valorMensalBRL: 500 },
    { item: "ElevenLabs Voice", valorMensalBRL: 550 },
...
/** Doze meses de faturas fictícias (uma por ferramenta por mês), terminando no mês atual (índice 0). */
