...
| 20 | [Daily Second Brain v1.1.1](daily-second-brain/) | Gestão | Memórias e decisões dispersas | Coletas agênticas agendadas, wiki conectada, grafo, chat e voz | ChatGPT, OpenRouter, Zapier MCP e ElevenLabs. Disco persistente no Render |
| 21 | [Mapify v1.0.2](mapify/) | Gestão, Educação e Produto | Conteúdo difícil de conectar e aplicar | Mapas mentais interativos com fontes, edição e conversa | ChatGPT por assinatura ou OpenRouter; YouTube, PDF, web e texto. Disco persistente no Render |
