...
| 21 | [Mapify v1.0.3](mapify/) | Gestão, Educação e Produto | Conteúdo difícil de conectar e aplicar | Mapas mentais interativos com fontes, edição e conversa | ChatGPT por assinatura ou OpenRouter; YouTube, PDF, web e texto. Disco persistente no Render |
