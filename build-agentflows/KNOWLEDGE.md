...
- **Faiss:** a tela mostra o caminho real da versão publicada. Antes da primeira indexação, mostra o padrão `DATA_DIR/knowledge-faiss/<base e versão>`. Cada indexação usa outra pasta; o caminho é administrado pelo app, sem importação de índices externos do Flowise.
