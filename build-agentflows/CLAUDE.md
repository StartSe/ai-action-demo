...
Limites de texto: hero 5 palavras, apoio 8; ajuda por campo em no máximo uma linha, detalhes técnicos recolhidos; cartões de integração em uma linha de benefício. Cor calculada em tasks/paleta-segmentos.json no segmento Gestão.
