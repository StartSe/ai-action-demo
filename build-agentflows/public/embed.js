...
(function () {
  ...
  function mount(options) {
    ...
    function toggle(value) { opened = value; frame.hidden = !opened; launcher.textContent = opened ? "Fechar conversa" : "Conversar"; launcher.setAttribute("aria-expanded", String(opened)); save(":open", String(opened)); }
