  ...
  return (
    <div className="print-sheet max-w-[860px] mx-auto px-8 py-10 max-md:px-4">
      ...
      <header className="mb-8 pb-4 border-b border-line">
        <div className="text-[13px] font-semibold text-muted">Leitura de Contratos</div>
        <h1 className="text-2xl font-extrabold tracking-[-0.01em]">{registro.saida.tipo_contrato || "Contrato"}</h1>
