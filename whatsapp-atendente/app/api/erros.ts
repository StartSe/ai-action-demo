...
// ganha o caso do número real: ErroWhatsApp (lib/whatsapp.ts), com a autorização vencida, o número
// ainda não verificado ou a janela de 24 horas da Meta — sempre com a ação para o cartão do WhatsApp.
import { respostaErro } from "@/lib/ai";
import { ErroWhatsApp } from "@/lib/whatsapp";
