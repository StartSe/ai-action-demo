"use client";
// Lista de todos os resultados salvos (qualquer tipo), com busca por texto. Copiado do app de referência trocando só
...
export default function Page() {
  ...
  return (
    <>
      <Topbar marca="P" nome="Precificador" area="Financeiro" status={status} erro={erro} usuario={status?.usuario} />
