        ...
        <>
          <section className="horizon-card">
            <div className="horizon-copy">
              ...
              >
                {ultimo ? "Explorar diagnóstico" : "Desenhar meu assessment"}
            ...
            <div className="horizon-map">
              <span className="map-coordinate">
                MAPA DE MATURIDADE / {ultimo ? "DADOS REAIS" : "6 DIMENSÕES"}
              </span>
        ...
        <div className="dashboard-columns">
                ...
                {visiveis.map((a) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Icone
                          nome={a.grupoTipo === "area" ? "people" : "layers"}
                        />
                      </span>
                      <button
            ...
            {detalhe && (
              <section className="assessment-detail">
                ...
                {detalhe.ultimoResultado && (
                  ...
                  >
                    Reabrir diagnóstico · {detalhe.ultimoResultado.respostas}{" "}
                    respostas analisadas
                    {detalhe.totalRespostas > detalhe.ultimoResultado.respostas
                      ? " · Há novas respostas"
                      : ""}{" "}
                    ↗
                  </Link>
          ...
          {tela === "visao" && (
            <aside className="agents-panel obs-panel">
              ...
              <button className="text-link" onClick={() => navegar("oficina")}>
        ...
        <>
          {ocupado ? (
            ...
            <div className="obs-panel empty-state">
              ...
              <p>
                Analise as respostas de um assessment ou explore um diagnóstico
                de exemplo.
              </p>
              <div className="detail-actions">
                <button
          ...
          {Boolean(painel?.resultados.length) && (
            <section className="obs-panel history-panel">
              ...
              {painel!.resultados.map((r) => (
                <Link key={r.id} className="history-row" href={`/r/${r.id}`}>
                  <Icone nome="chart" />
                  <div>
