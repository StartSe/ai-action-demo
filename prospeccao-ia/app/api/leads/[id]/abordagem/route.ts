...
import { criarAbordagem, listarAbordagens, obterConta, obterICP, obterLead, obterProduto, obterProspeccao, atualizarAbordagem } from "@/lib/workspace";
...
export async function GET(_req: Request, { params }: RouteContext<"/api/leads/[id]/abordagem">) {
  ...
  return Response.json({ lead, abordagem });
}
