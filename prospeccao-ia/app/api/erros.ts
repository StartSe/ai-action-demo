...
// antes da IA: ErroProspectHalo (lib/prospecthalo.ts, busca de leads) e ErroDescoberta (lib/descoberta.ts, pesquisa
...
export function responderErro(err: unknown, mensagemGenerica: string): Response {
  if (err instanceof ErroProspectHalo || err instanceof ErroDescoberta) {
