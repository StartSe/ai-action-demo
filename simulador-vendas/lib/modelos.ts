...
export const MODELOS_GRATUITOS: Opcao[] = [
  ...
  { valor: "google/gemini-2.5-flash", rotulo: "Gemini 2.5 Flash (pago, rápido)", grupo: "pago" },
  { valor: "google/gemini-2.5-pro", rotulo: "Gemini 2.5 Pro (pago)", grupo: "pago" },
  { valor: "openai/gpt-4.1-mini", rotulo: "GPT-4.1 mini (pago, rápido)", grupo: "pago" },
