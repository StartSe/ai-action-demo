...
// Nenhum tipo de formulário público é registrado neste app (sem registrarCallback): a capacidade
// "formulario" não está declarada em catalogo.json para analise-de-perda.
