...
// Próprio de cada app (nunca comparado por scripts/verificar-padrao.sh). Este app só usa a integração
// genérica OPENROUTER, sem nenhum estado derivado adicional.
