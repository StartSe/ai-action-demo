...
// cada app pode precisar importar seu próprio módulo para garantir que o callback já esteja registrado.
// Este app não tem nenhum formulário público (nenhum `tipo` chama registrarCallback): a validação
// acontece só pela tela principal ou pelo MCP. A rota continua aqui porque app/f/** é infraestrutura
// compartilhada da suíte; sem nenhum callback registrado, obterCallback(formulario.tipo) nunca acha
// nada e a resposta é só gravada, sem gerar resultado.
